...
static
FRESULT dir_rewind (
	DIRE *dj			/* Pointer to directory object */
)
{
	CLUST clst;
	FATFS *fs = FatFs;
...
static
FRESULT dir_find (
	DIRE *dj,		/* Pointer to the directory object linked to the file name */
...
static
FRESULT dir_read (
	DIRE *dj,		/* Pointer to the directory object to store read object name */
	BYTE *dir		/* 32-byte working buffer */
)
{
	FRESULT res;
...
static
FRESULT create_name (
	DIRE *dj,			/* Pointer to the directory object */
...
FRESULT follow_path (	/* FR_OK(0): successful, !=0: error code */
	DIRE *dj,			/* Directory object to return last directory and found object */
	BYTE *dir,			/* 32-byte working buffer */
...
FRESULT pf_opendir (
	DIRE *dj,			/* Pointer to directory object to create */
...
FRESULT pf_readdir (
	DIRE *dj,			/* Pointer to the open directory object */
